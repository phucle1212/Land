...
<div class="row">
  <div class="col-lg-8 col-sm-12 ">
    ...
    <!-- blog list -->
    <div class="row">
                              <div class="col-lg-4 col-sm-4 "><a href="<?php echo base_url(); ?>frontend/article/viewitem/<?php echo $val['id']; ?>" class="thumbnail"><img src="<?php echo $val['image']; ?>" alt="Hình ảnh"></a></div>
                              <div class="col-lg-8 col-sm-8 ">
                              <h3><a href="<?php echo base_url(); ?>frontend/article/viewitem/<?php echo $val['id']; ?>"><?php echo $val['title']; ?></a></h3>
