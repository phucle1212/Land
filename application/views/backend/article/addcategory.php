<section class="hhv-tabs">
	<h1>Thêm danh mục</h1>
	<ul>
		<li><a href="<?php echo base_url(); ?>backend/article/category" title="danh mục">Danh mục</a></li>
		<li class="active"><a href="<?php echo base_url(); ?>backend/article/addcategory" title="Thêm danh mục">Thêm danh mục</a></li>
	</ul>
</section>
	...
	<section class="main-panel">
		...
		<section class="block">
			...
			<label class="item">
				...
				<?php echo form_dropdown('data[parentid]', (isset($data['_show']['parentid'])?$data['_show']['parentid']:NULL),common_valuepost(isset($data['_post']['parentid'])?$data['_post']['parentid']:0),' class="cbSelect"'); ?>
			</label>
